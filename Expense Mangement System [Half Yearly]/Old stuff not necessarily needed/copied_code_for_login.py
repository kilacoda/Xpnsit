...
# #==============================METHODS========================================
# def Database():
#     global maindb, cursor
#
#     cursor = maindb.cursor()
#     cursor.execute("CREATE TABLE IF NOT EXISTS `member` (mem_id INTEGER NOT NULL PRIMARY KEY  AUTO_INCREMENT, username TEXT, password TEXT)")
...
#             root.deiconify()
# #==============================BUTTON WIDGETS=================================
# btn_login = Button(Form, text="Login", width=45, command=Database().Login())
